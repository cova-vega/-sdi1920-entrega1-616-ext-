...
//			// Voy a la pagina
	...
	public void PR15() {
		...
		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina(driver, "free", "//tbody/tr",
				PO_View.getTimeout());
		// Enviamos peticion
		elementos = SeleniumUtils.EsperaCargaPagina(driver, "class", "btn btn-if", PO_View.getTimeout());
		...
		SeleniumUtils.textoPresentePagina(driver, "alfonso");
		// Nos desconectamos
		PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
	}
	...
	public void PR17() {
		...
		PO_HomeView.clickOption(driver, "login", "id", "botonIdentificar");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "carlos@carlos.com", "123456");
		PO_View.getP();
		// Vamos al menu de usuarios
		driver.navigate().to("http://localhost:8090/user/list");
		// Enviamos peticion
		...
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "christian@christian.com", "123456");
		// Vamos a la pestaña de lista de peticiones
		driver.navigate().to("http://localhost:8090/request/list");
		// Comprobamos que hay una solicitud de el usuario ejemplo1: Pedro
	...
	public void PR18() {
		...
		List<WebElement> elementosLista = SeleniumUtils.EsperaCargaPagina(driver, "free", "//tbody/tr",
				PO_View.getTimeout());
		assertTrue(elementosLista.size() == 2);

		elementos = PO_View.checkElement(driver, "free",
				"//td[contains(text(), 'Alejandro')]/following-sibling::*/a[contains(@href, '/user/accept/')]");
		elementos.get(0).click();
		// Nos desconectamos
		PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
	}
	...
	public void PR19() {
		...
		// Comprobamos que esta bien la lista de amigos
		SeleniumUtils.textoPresentePagina(driver, "Alejandro");
		// Nos desconectamos
		PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
	}
	...
	public void PR20() {
		...
		SeleniumUtils.textoPresentePagina(driver, "Friend requests");
		SeleniumUtils.textoPresentePagina(driver, "Name");
		SeleniumUtils.textoPresentePagina(driver, "Email");
